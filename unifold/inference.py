    ...
    for seed in range(args.times):
        cur_seed = hash((args.data_random_seed, seed)) % 100000
         = load_feature_for_one_target(
            ...
            use_ubatchniprot=args.use_uniprot,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--param_path", type=str, default='/root/Uni-Fold/ckpt/monomer.unifold.pt', help="Path to model parameters."
    )
    parser.add_argument(
        "--data_random_seed",
        type=int,
